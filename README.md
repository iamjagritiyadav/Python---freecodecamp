...
The goal of this repository is to finish **all Python videos in the freeCodeCamp playlist** and store everything related to each video in an organized way.
...
- Projects implemented in the video
- Concept-wise explanations for revision
- Study material and notes related to that video
...
- Build a strong Python foundation from beginner to advanced level
